<template lang="pug">
  section.wrapper
    ...
    p
      ...
      |  towards certain goals. So climate change scenarios can come in two different forms, projections
      strong.green  “What can happen?”
      |  and goal-oriented pathways
