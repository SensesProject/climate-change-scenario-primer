<template lang="pug">
  section.wrapper
    ...
    p For comparison, a doubling of the atmospheric CO<sub>2</sub> concentration from preindustrial times, i.e. from ca. 280 parts per million (ppm) air molecules to 560&thinsp;ppm, would amount to a radiative forcing of 3.7&thinsp;W/m<sup>2</sup>. In 2016, the CO<sub>2</sub> concentration reached 400&thinsp;ppm.
